...
clnColumnIndex <- colSums(is.na(training_data))/nrow(training_data) < 0.9
training_data <- training_data[,clnColumnIndex]
validation_data <- validation_data[,clnColumnIndex]
```
